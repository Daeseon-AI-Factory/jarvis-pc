...
<!-- override-trigger: fa1b304 docs: e4243ff troubleshoot + narrative (Session Inspector NSPanel + actor→MainActor publish) [no-log] — 이 commit 자체가 *이전 commit e4243ff의 dual-write entries 박은 거*. 279 LOC threshold 넘긴 건 entry 자체 길이 (troubleshooting entry 17 line + narrative mdx 262 line). dual-write에 또 dual-write 박는 건 무한 loop. e4243ff Inspector 박은 거에 대해 narrative + troubleshooting 둘 다 박힌 게 이 commit. -->
